...
# Apache Sling Slingstart Archetype (deprecated)
...
For reference or potential bugfix releases use branch [maintenance](https://github.com/apache/sling-slingstart-archetype/tree/maintenance).